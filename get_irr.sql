...
where
	...
	and (lot.street_name like '%irr%' or lot.street_directional like '%irr%' or lot.addr_2 like '%irr%' or lot.misc_16 = '%irr%')
...
select *
from #LocateIrrigation

-- get a count
select 
	ST_Category,
	Count(ST_category) as Counts
from #LocateIrrigation
Group by 
	ST_Category


--drop table #LocateIrrigation